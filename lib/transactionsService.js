...
import { buildStandardTransactionPayload, isFinishingDepartment } from '@/lib/transactionDualScan';
 ...
 *                     dualScan?: boolean}>}
 */
export function validateStandardTransactionScan(scannedQr, user, innerQr = null, qcStatus = null) {
  return validateStandardScan({ scannedQr, user, db: guardDb, innerQr, qcStatus });
}
 ...
 */
export async function clearInnerQrForOrgQr(orgQr) {
