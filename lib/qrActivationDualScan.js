...
import { BLOCK_SRL_UNREACHABLE } from './transactionGuards.js';
...
/**
 * Run the Dual-Scan Inner Box validations (V1-V3) for one activation
 * submit. NOTHING is written here - the caller only continues to the
 * cut_qty guard and the activation inserts when the result is
 * { ok: true }.
 *
 * @param {object} params
 ...
 */
export async function validateActivationScan({ innerQr, orgQr, getSrlSize }) {
