// Small inline SVG icon set (no external icon dependencies).
...
export function ChevronLeftDoubleIcon(props) {
  return (
    <IconBase {...props}>
...
export function CompressIcon(props) {
  return (
    <IconBase {...props}>
      <path d="M9 9V4.5M9 9H4.5M9 9L3.75 3.75M15 9V4.5M15 9h4.5M15 9l5.25-5.25M9 15v4.5M9 15H4.5M9 15l-5.25 5.25M15 15v4.5M15 15h4.5M15 15l5.25 5.25" />
    </IconBase>
  );
}
